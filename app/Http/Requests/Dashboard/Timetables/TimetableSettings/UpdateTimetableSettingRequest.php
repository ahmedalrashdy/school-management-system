...
class UpdateTimetableSettingRequest extends FormRequest
{
    /**
    ...
    {
        $timetableSettingId = $this->route('timetable_setting')?->id;
        ...
        return array_merge([
            'name' => [
                ...
                'string',
                'max:255',
                Rule::unique('timetable_settings', 'name')->ignore($timetableSettingId),
            ],
