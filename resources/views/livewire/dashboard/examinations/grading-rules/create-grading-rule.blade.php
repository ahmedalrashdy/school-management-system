            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <x-form.input
                        ...
                        label="أعمال الفصل"
                        wire:model="coursework_max_marks"
                        step="1"
                        min="0"
                        x-bind:max="totalMarks"
                        required
                    ...
                    <x-form.input
                        ...
                        wire:model="final_exam_max_marks"
                        step="1"
                        min="0"
                        x-bind:max="totalMarks"
                        required
            ...
            document.addEventListener('alpine:init', function() {
                Alpine.data('createGradeRule', () => ({
                    ...
                    get courseworkWeightsSum() {
                        return this.courseworkItems.reduce((sum, item) => sum + (parseInt(item
                            .weight) || 0), 0);
                    },

                    get isCourseworkWeightsValid() {
                        // Validation: Sum must be 100 (percentage)
                        return this.courseworkWeightsSum == 100;
                    },
