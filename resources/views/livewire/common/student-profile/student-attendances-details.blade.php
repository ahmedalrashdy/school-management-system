<div>
    ...
    @else
        ...
        <div
            wire:loading
            wire:target="loadAttendance, termId"
        ...
        >
            ...
            <p class="mt-2 text-gray-500">جارِ تحميل سجل الحضور...</p>
        </div>

        @if ($dataLoaded)
            @if ($section && $calendar)
                <x-ui.portal.student-attendances-stats-and-calendar
                    :calendar="$calendar"
                    :stats="$stats"
                />
            @else
