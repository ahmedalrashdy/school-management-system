...
>
    <!-- Sidebar -->
    <div
        class="fixed h-screen inset-y-0 right-0 z-50 w-64 transform transition-transform duration-300 ease-in-out translate-x-full lg:translate-x-0 lg:static"
        ...
        <div
            ...
            <div class="flex items-center justify-center h-16 px-4 border-b border-gray-200 dark:border-gray-700">
                ...
                >
                    ...
                    @endif
                    <span
                        class="text-xl font-bold text-gray-900 dark:text-white">{{ school()->schoolSetting('school_name') }}</span>
                </a>
            </div>
